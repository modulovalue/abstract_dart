...
void main() {
    group("$DecimalField", () {
        test("addition", () {
            expect(const DecimalField().addition.operate(Decimal.fromInt(3), Decimal.fromInt(5)), Decimal.fromInt(8));
        });
        test("multiplication", () {
            expect(const DecimalField().multiplication.operate(Decimal.fromInt(3), Decimal.fromInt(5)), Decimal.fromInt(15));
        });
    });
    group("$DoubleField", () {
        test("addition", () {
